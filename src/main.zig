...
const command_play_audio = 2027;
const command_toggle_transcript = 2028;
const command_react_menu = 2029;
const command_next_message = 2030;
const command_prev_message = 2031;
const command_jump_latest = 2032;
const command_links = 2033;
const command_next_chat = 2034;
const command_prev_chat = 2035;
const command_emoji = 2036;
