...
pub fn build(b: *std.Build) void {
    ...
    for ([_][]const u8{ "src/emoji_picker.zig", "src/played.zig", "src/update.zig", "src/avatar_mask.zig", "src/compose_layout.zig", "src/scrollbar.zig", "src/media_age.zig", "src/telegram_json.zig" }) |test_root| {
